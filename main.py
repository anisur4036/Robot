...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8845622930:AAHtWyfa-2u-oV0-IfyD_x04_s1r01OtRS4"   # ← ADD BOT TOKEN
TOKEN = (
...
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "8008057402"))
...
BRAND       = "ANIS PREMIUM HOSTING"
BRAND_VER   = "MAKER-👑ANISUR RAHAMAN👑"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@Xenon_All_Bot"
UPDATE_CH   = "https://t.me/xenonxcarolineautolike"
...
PAYMENT_METHODS: Dict[str, Dict[str, Any]] = {
    "bkash":   {"name": "bKash",       "number": "01887239190",         "type": "Send Money",       "tag": "[B]"},
    "nagad":   {"name": "Nagad",       "number": "01887239190",         "type": "Send Money",       "tag": "[N]"},
    "rocket":  {"name": "Rocket",      "number": "01887239190",         "type": "Send Money",       "tag": "[R]"},
    "upay":    {"name": "Upay",        "number": "01887239190",         "type": "Send Money",       "tag": "[U]"},
    "binance": {"name": "Binance Pay", "number": "Binance ID SOON !","type": "USDT (BEP20/TRC20)","tag": "[BP]"},
...
_HELP_PAGES = {
    "main": {
        "title": "📚 Help Centre",
        "text": (
            "Welcome to <b>ANIS PREMIUM HOSTING</b>\n\n"
            "<b>Quick Start</b>\n"
